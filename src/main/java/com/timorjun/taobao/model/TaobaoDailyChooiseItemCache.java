...
@RedisHash("taobao-daily-goods-cache")
public class TaobaoDailyChooiseItemCache implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -296371326949226618L;
	...
	public TaobaoDailyChooiseItemCache() { 
